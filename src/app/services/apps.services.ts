    ...
    apps: App[] = [
        {
            ...
            icon: [
                '0 0 988 988',
                `M928,109.5H60c-33.1,0-60,26.9-60,60v649c0,33.1,26.9,60,60,60h868c33.1,0,60-26.9,60-60v-649
        ...
        },
        {
            ...
            icon: [
                '0 0 980 980',
                `M836.5,143.6c-45-45-97.399-80.3-155.7-105C620.3,13,556.101,0,490,0c-66.1,0-130.3,13-190.8,38.5
        ...
        },
        {
            ...
            icon: [
                '0 0 122.3 122.3',
                `M116.3,15.15H6c-3.3,0-6,2.7-6,6v80c0,3.3,2.7,6,6,6h110.3c3.3,0,6-2.7,6-6v-80C122.3,17.85,119.6,15.15,116.3,15.15z
        ...
        },
        {
            ...
            icon: [
                '0 0 965.199 965.199',
                `M263.85,30c0-16.6-13.4-30-30-30h-202c-16.6,0-30,13.4-30,30v202.1c0,16.6,13.4,30,30,30h202.1c16.6,0,30-13.4,30-30V30
                H263.85z 
