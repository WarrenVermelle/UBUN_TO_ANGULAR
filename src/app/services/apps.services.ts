...
export class AppsService {
    ...
    icons: Array<Icon> = [
        ...
        new Icon('house', '0 0 16 16', 'M14 5V3h-2.002z M2 7v8h9v-1H3V6.333zm11.002-1L13 15h1V7z M8 8.986a8.47 8.47 0 0 1 .607-.122 5.24 5.24 0 0 1 .872-.064c.295 0 .54.043.735.129.195.08.35.197.465.35.119.147.202.326.25.535.047.21.071.44.071.693V14.2H8z M8 .293L.146 8.146l.708.708L8 1.707l7.146 7.147.708-.708z'),
    ];

    softwares: Array<Software> = [
        new Software('identity', this.icons[1] , false, false, 0, true, 0, false, 0, 0, true, false, false, false),
        new Software('browser', this.icons[2], true, true, 0, false, 0, false, 0, 1, true, true, true, false),
    ...
    explorer: Array<Explorer> = [
        new Explorer('recent', new Icon('', '', '')),
        new Explorer('starred', new Icon('', '', '')),
        new Explorer('home', new Icon('', '', ''), [
            new Explorer('desktop', new Icon('', '', '')),
            new Explorer('documents', new Icon('', '', '')),
            new Explorer('downloads', new Icon('', '', '')),
            new Explorer('music', new Icon('', '', '')),
            new Explorer('pictures', new Icon('', '', '')),
            new Explorer('videos', new Icon('', '', ''))
        ]),
        new Explorer('trash', new Icon('', '', '')),
        new Explorer('other locations', new Icon('', '', '')),
    ]

    shortcuts: Array<Software> = [
        this.softwares[0]
    ]
    ...
    // getFocusedApp() {
    //     const app = this.apps.find(app => app.win_status.focused === true);
    //     if(app !== undefined)
    //     {
    //         return app;
    //     }
